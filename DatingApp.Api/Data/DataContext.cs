...
namespace DatingApp.Api.Data
{
    ...
    {
        public DataContext(DbContextOptions pDataContext) : base(pDataContext) { }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Like>().HasOne(u => u.Likee)
                .WithMany(u => u.Likers).HasForeignKey(u => u.LikeeId)
                .OnDelete(DeleteBehavior.Restrict);
            builder.Entity<Like>().HasOne(u => u.Liker)
                .WithMany(u => u.Likees).HasForeignKey(u => u.LikerId)
                .OnDelete(DeleteBehavior.Restrict);
