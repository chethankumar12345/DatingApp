...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function login(model) {
          ...
          return this._http.post(this.baseUrl + 'login', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            ...
            if (user) {
              ...
              console.log(_this6.currentUser.thumbnailUrl);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_10__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["BsDropdownModule"].forRoot(), ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_33__["BsDatepickerModule"].forRoot(), ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["PaginationModule"].forRoot(), ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["TabsModule"].forRoot(), ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["ButtonsModule"].forRoot(), _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_20__["appRoutes"]), _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_7__["JwtModule"].forRoot({
        config: {
          ...
          whitelistedDomains: ['localhost:49362'],
          blacklistedRoutes: ['localhost:49362/api/auth']
        }
  ...
  function srcAppMembersMemberDetailMemberDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MemberDetailComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {//this.route.data.subscribe(data => {
          //  this.user = data['user'];
          //});
          ...
          this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
              ...
              if (photo.isMain) {
                ...
                _this17.authService.changeMemberThumbnailPhoto(photo.thumbnailUrl);

                _this17.authService.currentUser.thumbnailUrl = photo.thumbnailUrl;
      ...
      _createClass(NavComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.currentThumbnailPhotoUrl.subscribe(function (photoUrl) {
            console.log(_this23.photoUrl);
            _this23.photoUrl = photoUrl;
          });
        }
      }, {
        key: "login",
        value: function login() {
          ...
          this.authService.login(this.model).subscribe(function (next) {
            _this24.alertify.success('Logged in sucessfully');
          }, function (error) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function register() {
          ...
          this.authService.register(this.user).subscribe(function () {
            _this25.alertify.success('register success');
          }, function (error) {
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      production: false,
      apiUrl: 'http://datingapp-chethan.azurewebsites.net/api/'
    };
    /*
